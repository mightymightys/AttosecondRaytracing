...
# #loop_variable_values = np.random.normal(loc=0, scale=0.5, size=100) # normally distributed angles of std 0.5° around 0
...
#loop_variable_values = np.random.normal(loc=0, scale=np.rad2deg(1e-3), size=100) # normally distributed angles of std 1mrad around 0
