...
def OEPlacement(SourceProperties : dict, OpticsList : list, DistanceList : list[(int, float)], \
    ...
    if total_nested >1:
        ...
        for x in loop_variable:
            loop_list[i] = x
            ModifiedOpticalChain = _singleOEPlacement(SourceProperties, OpticsList, DistanceList, IncidenceAngleList, IncidencePlaneAngleList, Description)
        ...
        OpticalChain = _singleOEPlacement(SourceProperties, OpticsList, DistanceList, IncidenceAngleList, IncidencePlaneAngleList, Description) #all simple
        if render: 
            mlab.options.offscreen = True
